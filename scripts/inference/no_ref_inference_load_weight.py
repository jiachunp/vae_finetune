...
from talking_head.pipelines.video_pipeline import VideoPipeline
...
def inference_process(args: argparse.Namespace):
    ...
    for key in state_dict.keys():
        if "reference_unet" in key:
            state_dict[key] = state_dict[key.replace("reference_unet", "denoising_unet")]
