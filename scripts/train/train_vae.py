...
from talking_head.models.vae.util import exists, instantiate_from_config, isheatmap
...
def init_wandb(save_dir, opt, config, group_name, name_str):
    ...
    if opt.debug:
        ...
        wandb.init(
            ...
            config=config,
            settings=wandb.Settings(code_dir="./talking_head"),
            group=group_name,
            name=name_str,
        )
...
if __name__ == "__main__":
    ...
    try:
        ...
        default_callbacks_cfg = {
            "setup_callback": {
                "target": "talking_head.models.vae.util.SetupCallback",
                "params": {
                    "resume": opt.resume,
                    "now": now,
                    "logdir": logdir,
            ...
            "image_logger": {
                "target": "talking_head.models.vae.util.ImageLogger",
